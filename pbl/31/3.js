function addTmplFile() {
	...
	// 将input中的值变为空
	document.getElementById("zhuanye").value = null;
	document.getElementById("fuze").value = null;
	document.getElementById("kecheng").value = null;
	document.getElementById("students").value = null;
	document.getElementById("teacher").value = null;
	document.getElementById("teaching").value = null;
}
...
function submit1() {
	...
	var fuze = document.getElementById("fuze").value;
	...
	zhuanye = document.createTextNode(zhuanye);
	fuze = document.createTextNode(fuze);
	kecheng = document.createTextNode(kecheng);
	students = document.createTextNode(students);
	teacher = document.createTextNode(teacher);
	teaching = document.createTextNode(teaching);
	...
	td1.className = "col1";
	td1.appendChild(zhuanye);
	var td2 = document.createElement("td");
	td2.className = "col2";
	td2.appendChild(fuze);
	var td3 = document.createElement("td");
	td3.className = "col3";
	td3.appendChild(kecheng);
	var td4 = document.createElement("td");
	td4.className = "col4";
	td4.appendChild(students);
	var td5 = document.createElement("td");
	td5.className = "col5";
	td5.appendChild(teacher);
	var td6 = document.createElement("td");
	td6.className = "col6";
	td6.appendChild(teaching);
...
function modify(obj) {
	...
	// 将输入的值变为这一行的数据
	var zhuanye = document.getElementById("zhuanye").value = objTd[0].innerText;
	var fuze = document.getElementById("fuze").value = objTd[1].innerText;
	var kecheng = document.getElementById("kecheng").value = objTd[2].innerText;
	var students = document.getElementById("students").value = objTd[3].innerText;
	var teacher = document.getElementById("teacher").value = objTd[4].innerText;
	var teaching= document.getElementById("teaching").value = objTd[5].innerText;
	var onlyId = document.getElementById("id").value = objTd[6].innerText;
}
...
function submit2() {
	...
	// 修改编辑行的数据
	objTd[0].innerText = document.getElementById("zhuanye").value;
	
	objTd[1].innerText = document.getElementById("fuze").value;
	objTd[2].innerText = document.getElementById("kecheng").value;
	objTd[3].innerText = document.getElementById("students").value;
	objTd[4].innerText = document.getElementById("teacher").value;
	objTd[5].innerText = document.getElementById("teaching").value;
	objTd[6].innerText = document.getElementById("id").value;
}
