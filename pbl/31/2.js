function addTmplFile() {
	...
	document.getElementById("remarkss").value = null;
	document.getElementById("title").value = null;
	document.getElementById("address").value = null;
	document.getElementById("remarks").value = null;
	document.getElementById("low").value = null;
	document.getElementById("high").value = null;
}
...
function submit1() {
	...
	remarkss = document.createTextNode(remarkss);
	low = document.createTextNode(low);
	high = document.createTextNode(high);
	...
	td5.className = "col5";
	td5.appendChild(remarkss);
	var td6 = document.createElement("td");
	td6.className = "col6";
	td6.appendChild(low);
	var td7 = document.createElement("td");
	td7.className = "col7";
	td7.appendChild(high);
...
function modify(obj) {
	...
	var title = document.getElementById("title").value = objTd[1].innerText;
	var address = document.getElementById("address").value = objTd[2].innerText;
	var remarks = document.getElementById("remarks").value = objTd[3].innerText;
	var remarkss = document.getElementById("remarkss").value = objTd[4].innerText;
	var low = document.getElementById("low").value = objTd[5].innerText;
	var high = document.getElementById("high").value = objTd[6].innerText;
	var onlyId = document.getElementById("id").value = objTd[7].innerText;
}
...
function submit2() {
	...
	objTd[1].innerText = document.getElementById("title").value;
	objTd[2].innerText = document.getElementById("address").value;
	objTd[3].innerText = document.getElementById("remarks").value;
	objTd[4].innerText = document.getElementById("remarkss").value;
	objTd[5].innerText = document.getElementById("low").value;
	objTd[6].innerText = document.getElementById("high").value;
	objTd[7].innerText = document.getElementById("id").value;
}
