...
btnadd.onclick = function () {
    ...
    btnadddata.onclick = function () {
        ...
        var tr = document.createElement("tr")
        tr.innerHTML = "<td>" + zym1 + "</td>" + "<td>" + fzr1 + "</td>" + "<td>" + kcsl1 + "</td>" + "<td>" + xssl1 + "</td>" + "<td>" + ssb1 + "</td>" + "<td>" + cjppd1 + "</td>" + "<td>" + '<button class="ck">查看</button>' + "</td>" + "<td>" + '<button class="del">删除</button><button class="update">修改</button>' + "</td>"
        var tbody = document.getElementById("tbxi")
        tbody.appendChild(tr)
        alert("添加成功");
